...
if os.name == 'nt':
    ARIA2_PATH = os.path.join(TOOLS_DIR, "aria2c.exe")
else:
    # Linux / Termux
    ARIA2_PATH = "aria2c" # Usar PATH del sistema por defecto

HAS_ARIA2 = shutil.which("aria2c") is not None or os.path.exists(ARIA2_PATH)
